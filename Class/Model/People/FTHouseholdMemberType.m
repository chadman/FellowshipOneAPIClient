...
@implementation FTHouseholdMemberType

@synthesize url, myId, name;

+ (FTHouseholdMemberType *) populateFromDictionary:(NSDictionary *)dict {

	return [[[FTHouseholdMemberType alloc] initWithDictionary:dict] autorelease];
}
...
- (id) initWithCoder: (NSCoder *)coder {
	...
	self = [[FTHouseholdMemberType	 alloc] init];
