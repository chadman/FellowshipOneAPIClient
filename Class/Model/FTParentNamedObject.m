...
@interface FTParentNamedObject (PRIVATE)
...
@implementation FTParentNamedObject
@synthesize myId;
@synthesize url;
@synthesize name;
...
+ (FTParentNamedObject *)populateFromDictionary: (NSDictionary *)dict {
	
	return [[[FTParentNamedObject alloc] initWithDictionary:dict] autorelease];
}
...
- (id) initWithCoder: (NSCoder *)coder {
	...
	self = [[FTParentNamedObject alloc] init];
