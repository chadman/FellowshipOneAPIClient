...
@interface FTParentObject (PRIVATE)
...
+ (FTParentObject *)populateFromDictionary: (NSDictionary *)dict {
	...
	return [[[FTParentObject alloc] initWithDictionary:dict] autorelease];
}
...
- (id) initWithCoder: (NSCoder *)coder {
	...
	self = [[FTParentObject alloc] init];
